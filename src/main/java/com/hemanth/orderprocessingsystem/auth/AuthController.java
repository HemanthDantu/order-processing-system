...
/**
 * Authentication endpoint entry point.
 *
 * <p>The controller is intentionally thin so the request/response contract is
 * easy to follow and the auth rules stay in the service layer.</p>
 */
@RestController
...
public class AuthController {
    ...
    /**
     * Authenticates a user and returns a bearer token on success.
     *
